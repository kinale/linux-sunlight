...
void __init sched_init(void)
{
	...
	printk(KERN_INFO
	       "CacULE CPU scheduler (RDB) v5.15 by Hamad Al Marri. Aligned by Ionut Nechita.");
#else
	printk(KERN_INFO "CacULE CPU scheduler v5.15 by Hamad Al Marri. Aligned by Ionut Nechita.");
#endif
#endif
